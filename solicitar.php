...
<!--FORMULARIO-->
    <section class="formulario">
        ...
        <form id="formulario" action="https://formsubmit.co/sosgruavenezuela@gmail.com" method="post" autocomplete="off">
       ...
       <input type="hidden" name="_next" value="http://localhost/modelo/index.php#formulario">
